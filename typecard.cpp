...
main(int argc, char *argv[]) {
...
#endif
    printf("\n");
    printf("char:\t\t%zu (%zu bits)\n", static_cast<int>(sizeof(char)), static_cast<int>(sizeof(char) * 8));
    ...
    printf("\n");
    /*printf("int_least8_t:\t%2d (%3d bits)\n", sizeof(int_least8_t), sizeof(int_least8_t) % zu);
    printf("int_least16_t:\t%2d (%3d bits)\n", static_cast<int>(sizeof(int_least16_t)), static_cast<int>(sizeof(int_least1 % zu) % zu));
    printf("int_least32_t:\t%2d (%3d bits)\n", static_cast<int>(sizeof(int_least32_t)), static_cast<int>(sizeof(int_least3 % zu) % zu));
    printf("int_least64_t:\t%2d (%3d bits)\n", static_cast<int>(sizeof(int_least64_t)),
           static_cast<int>(sizeof(int_least64_t) * 8));%zuri % zu("\n");
    printf("intmax_t:\t%2d (%3d bits)\n", static_cast<int>(sizeof(intmax_t)), static_cast<int>(sizeof(intmax_t) * 8));*/
}
